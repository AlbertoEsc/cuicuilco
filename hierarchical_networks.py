...
def NetworkSetPCASFAExpo(network, first_pca_expo=0.0, last_pca_expo=1.0, first_sfa_expo=1.2, last_sfa_expo=1.0,
                         hard_pca_expo=False):
    num_layers = len(network.layers)
    if num_layers > 1:
        for i, layer in enumerate(network.layers):
            if not hard_pca_expo:
                layer.sfa_args["pca_expo"] = \
                    first_pca_expo + (last_pca_expo - first_pca_expo) * i * 1.0 / (num_layers - 1)
            else:
                if i == num_layers - 1:
...
# layer.ord_args = {"pre_expansion_node_class":None, "expansion_funcs":[identity, QT],"max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.999, "output_dim":35} #output_dim":40
# layer.ord_args = {"pre_expansion_node_class":None, "expansion_funcs":[identity],"max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.999, "output_dim":35} #output_dim":40
layer.exp_funcs = [identity, ]
# layer.exp_funcs = [encode_signal_p9,] #For next experiment: [encode_signal_p9,]
# layer.red_node_class = mdp.nodes.HeadNode
...
# "expansion_starting_point":"08Exp", "max_lenght_slow_part":10,   "offsetting_mode":"sensitivity_based_pure",
# "max_preserved_sfa":1.99999, "expansion_output_dim":4000}
# layer.sfa_args = {"pre_expansion_node_class":None, "expansion_funcs":[identity, unsigned_08expo],
# "max_lenght_slow_part":10,   "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
...
# layer.sfa_args = {"pre_expansion_node_class":None, "expansion_funcs":expansion,"max_lenght_slow_part":None,
...
network.L0.exp_funcs = [
    he.cos_exp_mix30_F]  # [identity, sel30_QT, sel30_CT ] he.cos_exp_mix30_F] # sel60_QT # he.cos_exp_mix25_F
#  he.cos_exp_mix60q_F , sel25_QT, sel25_CT
...
network.L0.sfa_args = {}
# network.L0.sfa_args = {"exp_func":he.cos_exp_mix8_F, "feats_at_once":60, "norm_class":he.NormalizeABNode,}
# #he.cos_exp_I_3D_F, smartD, he.cos_exp_I_smart2D_F, cos_exp_mix1_F
...
network.L0.sfa_out_dim = 60  # 100 #49 * 2 # *3
# network.L0.sfa_args = {"exp_func":he.cos_exp_mix8block25n20n15c_F, "factor_projection_out":0.72,
# "factor_mode"":"constant", "feats_at_once":10, "norm_class":he.NormalizeABNode,} #he.cos_exp_I_3D_F,
# smartD, he.cos_exp_I_smart2D_F, cos_exp_mix1_F
network.L0.sfa_args = {"exp_func": he.cos_exp_mix8_F, "factor_projection_out": 0.97, "factor_mode": "decreasing",
                       "feats_at_once": 2,
                       "norm_class": he.NormalizeABNode, }  # he.cos_exp_I_3D_F, smartD,
# he.cos_exp_I_smart2D_F, cos_exp_mix1_F
...
# GTSRBNetwork.L0.ord_node_class = mdp.nodes.GSFANode
# GTSRBNetwork.L0.ord_args = {"output_dim": 120} #75/3 = 25, This number of dimensions are not expanded!
# sel_exp(42, unsigned_08expo)
# GTSRBNetwork.L0.exp_funcs = [identity, unsigned_08expo] #pair_prodsigmoid_04_adj2_ex, unsigned_08expo,
# unsigned_2_08expo
# GTSRBNetwork.L0.exp_funcs = [identity, unsigned_08expo, numpy.sign, pair_smax25_mix1_ex, pair_smax50_mix1_ex,
# pair_smax_mix1_ex], sel14_MaxE, pair_max_mix1_ex]
...
GTSRBNetwork.L0.exp_funcs = [identity,
                             QT]  # , QT, maximum_99mix2_s08_ex, sel80_QT, QT] #maximum_99mix2_s08_ex, sel80_QT
# maximum_75mix2_ex, media50_adj2_ex, pair_max90_mix1_ex, modulation50_adj1_08_ex, unsigned_08expo,
# sel90_unsigned_08expo
# GTSRBNetwork.L0.exp_funcs = [identity,]
...
# GTSRBNetwork.L0.sfa_args = {"pre_expansion_node_class":None, "expansion_funcs":expansion,"max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.999}
...
# #
# #
# #GTSRBNetwork.L1.exp_funcs =  [identity, unsigned_08expo] # Q_N_k1_d2_L # [identity, unsigned_08expo]
#  sel_exp(42, unsigned_08expo)] #pair_prodsigmoid_04_adj2_ex
...
pSFALayerL0.name = comp_layer_name(pSFALayerL0.cloneLayer, pSFALayerL0.exp_funcs, pSFALayerL0.x_field_channels,
                                   pSFALayerL0.y_field_channels, pSFALayerL0.pca_out_dim, pSFALayerL0.sfa_out_dim)
...
pSFALayerL0.sfa_args = {"pre_expansion_node_class": None, "expansion_funcs": [identity, unsigned_08expo],
                        "max_lenght_slow_part": 10, "offsetting_mode": "sensitivity_based_pure",
...
pSFALayerL2H.name = comp_layer_name(pSFALayerL2H.cloneLayer, pSFALayerL2H.exp_funcs, pSFALayerL2H.x_field_channels,
                                    pSFALayerL2H.y_field_channels, pSFALayerL2H.pca_out_dim, pSFALayerL2H.sfa_out_dim)
...
pSFALayerL2V.name = comp_layer_name(pSFALayerL2V.cloneLayer, pSFALayerL2V.exp_funcs, pSFALayerL2V.x_field_channels,
                                    pSFALayerL2V.y_field_channels, pSFALayerL2V.pca_out_dim, pSFALayerL2V.sfa_out_dim)
...
pSFALayerL3V.sfa_args = {"pre_expansion_node_class": None, "expansion_funcs": [identity, unsigned_08expo],
                         "expansion_starting_point": None, "max_lenght_slow_part": 10,
...
L0.sfa_args = {"pre_expansion_node_class": None, "expansion_funcs": [identity, unsigned_08expo],
               "max_lenght_slow_part": 9, "reconstruct_with_sfa": False, "offsetting_mode": None,
               "max_preserved_sfa": 9}
L0.sfa_out_dim = 17
L1 = network.layers[1]
L1.sfa_out_dim = 40
...
def QT_3Split_15_AP02(x):
    ...
    return numpy.concatenate(
        (QT_AP(x[:, 0:15], d=0.2), QT_AP(x[:, s:s + 15], d=0.2), QT_AP(x[:, 2 * s:2 * s + 15], d=0.2)), axis=1)


def QT_3Split_15_AP03(x):
    s = x.shape[1] / 3
    return numpy.concatenate(
        (QT_AP(x[:, 0:15], d=0.3), QT_AP(x[:, s:s + 15], d=0.3), QT_AP(x[:, 2 * s:2 * s + 15], d=0.3)), axis=1)


def QT_3Split_15_AP06(x):
    s = x.shape[1] / 3
    return numpy.concatenate(
        (QT_AP(x[:, 0:15], d=0.6), QT_AP(x[:, s:s + 15], d=0.6), QT_AP(x[:, 2 * s:2 * s + 15], d=0.6)), axis=1)


def QT_3Split_15_AP08(x):
    s = x.shape[1] / 3
    return numpy.concatenate(
        (QT_AP(x[:, 0:15], d=0.8), QT_AP(x[:, s:s + 15], d=0.8), QT_AP(x[:, 2 * s:2 * s + 15], d=0.8)), axis=1)
...
def QT_3Split_35_AP08(x):
    s = x.shape[1] / 3
    return numpy.concatenate(
        (QT_AP(x[:, 0:35], d=0.8), QT_AP(x[:, s:s + 35], d=0.8), QT_AP(x[:, 2 * s:2 * s + 35], d=0.8)), axis=1)
...
# "expansion_funcs":[identity, unsigned_08expo, QT_3Split_15], "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
...
# "expansion_funcs":[identity, unsigned_08expo, QT_3Split_25, CT_3Split_20], "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
# pSFALayerL2H_S3_D2.sfa_args = {"pre_expansion_node_class":None,
# "expansion_funcs":[identity, unsigned_08expo,  QT_2Split_15_AP08], "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
...
# "expansion_funcs":[identity, unsigned_08expo, QT_2Split_25, CT_2Split_20], "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
# pSFALayerL3H_S2_D1.sfa_args = {"pre_expansion_node_class":None,
# "expansion_funcs":[identity, unsigned_08expo, QT_2Split_50], "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
# pSFALayerL3H_S2_D1.sfa_args = {"pre_expansion_node_class":None,
# "expansion_funcs":[identity, unsigned_08expo,  QT_3Split_35_AP08], "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
...
# sfa_args = {"pre_expansion_node_class":None,
# "expansion_funcs":[identity, unsigned_08expo, QT_3Split_20, CT_3Split_15], "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
...
# "expansion_funcs":[identity, unsigned_08expo, QT_2Split_35, CT_2Split_25], "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
pSFALayerL3V_S2_D1.sfa_args = {"pre_expansion_node_class": None, "expansion_funcs": [identity, unsigned_08expo, ],
                               "max_lenght_slow_part": 1, "offsetting_mode": "sensitivity_based_pure",
                               "max_preserved_sfa": 1.99999}
...
# pSFALayerL3V_S2_D1.sfa_args = {"pre_expansion_node_class":None,
# "expansion_funcs":[identity, unsigned_08expo], "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
# pSFALayerL3V_S2_D1.sfa_args = {"pre_expansion_node_class":None,
# "expansion_funcs":"RandomSigmoids", "expansion_starting_point":"08Exp", "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999, "expansion_output_dim":2000}
# pSFALayerL3V_S2_D1.sfa_args = {"pre_expansion_node_class":None,
# "expansion_funcs":[identity, QT, CT], "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
...
# "max_lenght_slow_part":1, ,  "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999}
# pSFALayerSupernode.sfa_args = {"pre_expansion_node_class":None,
...
network.L0.sfa_args = {"pre_expansion_node_class": None, "expansion_funcs": [identity, unsigned_08expo, s7QT],
                       "max_lenght_slow_part": 9, "offsetting_mode": "sensitivity_based_pure",
                       "max_preserved_sfa": 1.99999}
...
network.L1.sfa_args = {"pre_expansion_node_class": None,
                       "expansion_funcs": [identity, unsigned_08expo, ch3o3s3QT, ch3o0s3QT], "max_lenght_slow_part": 9,
                       "offsetting_mode": "sensitivity_based_pure", "max_preserved_sfa": 1.99999}
...
network.L2.sfa_args = {"pre_expansion_node_class": None,
                       "expansion_funcs": [identity, unsigned_08expo, ch3o4s9QT, ch3o0s4QT], "max_lenght_slow_part": 9,
                       "offsetting_mode": "sensitivity_based_pure", "max_preserved_sfa": 1.99999}
network.L2.cloneLayer = False

network.L3 = copy.deepcopy(network.L1)
network.L3.sfa_args = {"pre_expansion_node_class": None,
                       "expansion_funcs": [identity, unsigned_08expo, ch3o6s16QT, ch3o0s4QT], "max_lenght_slow_part": 9,
                       "offsetting_mode": "sensitivity_based_pure", "max_preserved_sfa": 1.99999}
...
pSFALayerL1.cloneLayer = False
pSFALayerL1.name = comp_layer_name(pSFALayerL1.cloneLayer, pSFALayerL1.exp_funcs, pSFALayerL1.x_field_channels,
                                   pSFALayerL1.y_field_channels, pSFALayerL1.pca_out_dim, pSFALayerL1.sfa_out_dim)
system_parameters.test_object_contents(pSFALayerL1)
...
pSFALayerL2.name = comp_layer_name(pSFALayerL2.cloneLayer, pSFALayerL2.exp_funcs, pSFALayerL2.x_field_channels,
                                   pSFALayerL2.y_field_channels, pSFALayerL2.pca_out_dim, pSFALayerL2.sfa_out_dim)
...
pSFALayerNL0.name = comp_layer_name(pSFALayerNL0.cloneLayer, pSFALayerNL0.exp_funcs, pSFALayerNL0.x_field_channels,
                                    pSFALayerNL0.y_field_channels, pSFALayerNL0.pca_out_dim, pSFALayerNL0.sfa_out_dim)
...
pSFALayerNL1.name = comp_layer_name(pSFALayerNL1.cloneLayer, pSFALayerNL1.exp_funcs, pSFALayerNL1.x_field_channels,
                                    pSFALayerNL1.y_field_channels, pSFALayerNL1.pca_out_dim, pSFALayerNL1.sfa_out_dim)
...
pSFALayerNL2.name = comp_layer_name(pSFALayerNL2.cloneLayer, pSFALayerNL2.exp_funcs, pSFALayerNL2.x_field_channels,
                                    pSFALayerNL2.y_field_channels, pSFALayerNL2.pca_out_dim, pSFALayerNL2.sfa_out_dim)
...
layer.name = comp_layer_name(layer.cloneLayer, layer.exp_funcs, layer.x_field_channels, layer.y_field_channels,
                             layer.pca_out_dim, layer.sfa_out_dim)
...
LN_PCA_out_dims = [L0_PCA_out_dim, L1_PCA_out_dim, L2_PCA_out_dim, L3_PCA_out_dim, L4_PCA_out_dim, L5_PCA_out_dim,
                   L6_PCA_out_dim, L7_PCA_out_dim, L8_PCA_out_dim, L9_PCA_out_dim, L10_PCA_out_dim]
...
if LRec_use_RGB_images:
    network.layers[0].pca_out_dim = 50  # 50 Problem, more color components also remove higher frequency ones = code
    # image as intensity+color!!!
else:
...
if not LRec_use_RGB_images:
    ...
    #    HiGSFANet_out_dims = [ 31, 52, 75, 85, 90, 90, 85, 100, 75,75,75 ] #OFFICIAL FOR AGE ARTICLE HGSFA+PC,
    # TOP NETWORK, 3 FEATS
    ...
    #    HiGSFANet_out_dims = [ 20, 30, 43, 70, 82, 76, 84, 82, 75, 75, 75] #CONTROL EXPERIMENT FOR AGE ARTICLE,
    # HGSFA, PLAIN SFA ARCHITECTURE WITHOUT PRINCIPAL COMPONENTS, 3Feats
...
for i, layer in enumerate(network.layers):
    ...
    # layer.sfa_args = {"expansion_funcs":[identity, unsigned_08expo], "max_lenght_slow_part":10, ,
    # "max_preserved_sfa":2.0}
    #    layer.sfa_args = {"expansion_funcs":[identity, unsigned_08expo], "max_lenght_slow_part":1, ,
    ...
    # features"
# layer.sfa_args = {"expansion_funcs":None, "use_pca":True, "operation":"lin_app", ""max_lenght_slow_part"":10,
# "max_num_samples_for_ev":1200, "max_test_samples_for_ev":1200, "k":200} layer.sfa_args = {"expansion_funcs":None,
# "use_pca":True, "max_lenght_slow_part":6, "max_num_samples_for_ev":600, "max_test_samples_for_ev":600,
# "k":16} network.layers[0].pca_node_class = mdp.nodes.PCANode network.layers[0].pca_out_dim = 13
...
network = HSFANetworkU11L_Overlap6x6L0_GUO_3Labels_96x96 = copy.deepcopy(
    HiGSFANetworkU11L_Overlap6x6L0_GUO_3Labels_96x96)
...
# SFANet_out_dims = [ 14, 20, 27, 49, 60, 61, 65, 65, 66, 70, 75]
# #eedit WARNING, REDUCING FROM 75 TO 70 FEATS TO AVOID NUMERIC ERROR
# SFANet_out_dims = [ 40, 20, 27, 49, 60, 61, 65, 65, 66, 70, 75]
# #eedit WARNING, REDUCING FROM 75 TO 70 FEATS TO AVOID NUMERIC ERROR
# SFANet_out_dims = [ 14, 20, 27, 49, 60, 61, 65, 65, 70, 75, 75]
# #eedit WARNING, INCREASING FROM 66 to 70 FEATS TO AVOID NUMERIC ERROR
factor_out_dim = 1.0
...
network.layers[1].sfa_args["expansion_funcs"] = [ch3s8, ch3s12u08, ch3s10max,
                                                 ch3o0s3QT]  # ch3s8, ch3s12u08, ch3s10max, ch3o0s3QT
network.layers[2].sfa_args["expansion_funcs"] = [ch3s18, ch3s18u08, ch3s16max]  # ch3s18, ch3s18u08, ch3s16max
network.layers[3].sfa_args["expansion_funcs"] = [ch3s25, ch3s23u08, ch3s19max,
                                                 ch3o0s3QT]  # ch3s25, ch3s25u08, ch3s19max, ch3o0s3QT
network.layers[4].sfa_args["expansion_funcs"] = [ch3s49, ch3s43u08, ch3s19max, ]  # ch3s49, ch3s43u08, ch3s19max,
network.layers[5].sfa_args["expansion_funcs"] = [ch3s58, ch3s37u08, ch3s13max,
                                                 ch3o0s3QT]  # ch3s58, ch3s37u08, ch3s13max, ch3o0s3QT
...
network.layers[0].pca_node_class = mdp.nodes.PCANode
if LRec_use_RGB_images:
    network.layers[0].pca_out_dim = 56  # 50 Problem, more color components also remove higher frequency ones = code
    # image as intensity+color!!!
else:
    network.layers[0].pca_out_dim = 20  # 16 #20 #30 #28 #20 #22 more_feats2, 50 for RGB
...
for i, layer in enumerate(network.layers):
    ...
    # layer.sfa_args = {"pre_expansion_node_class":None, "expansion_funcs":[identity, unsigned_08expo],
    # "max_lenght_slow_part":10,   "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99}
...
# noise_args=(-(3**0.5)*noise_addition, (3**0.5)*noise_addition), noise_type='additive')
...
if LRec_use_RGB_images:
    network.layers[0].pca_out_dim = 56  # 50 Problem, more color components also remove
    # higher frequency ones = code image as intensity+color!!!
else:
    network.layers[0].pca_out_dim = 20  # 16 #20 #30 #28 #20 #22 more_feats2, 50 for RGB
...
for i, layer in enumerate(network.layers):
    ...
    #    layer.sfa_args = {"expansion_funcs":[identity, unsigned_08expo], "use_pca":True, "max_lenght_slow_part":1,
    # "max_num_samples_for_ev":800, "max_test_samples_for_ev":200, "k":8}
    #    layer.sfa_args = {"expansion_funcs":None, "use_pca":True, "max_lenght_slow_part":10,
    # "max_num_samples_for_ev":800, "max_test_samples_for_ev":800, "k":92}
    #    layer.sfa_args = {"expansion_funcs":[identity, unsigned_08expo], "use_pca":True, "operation":"average",
    # "max_lenght_slow_part":10, "max_num_samples_for_ev":1200, "max_test_samples_for_ev":1200, "k":92}
    #    layer.sfa_args = {"expansion_funcs":None, "use_pca":True, "use_sfa":True, "operation":"average",
    # "max_lenght_slow_part":10, "max_num_samples_for_ev":600, "max_test_samples_for_ev":600, "k":92}
    # #    layer.sfa_args = {"expansion_funcs":[identity, unsigned_08expo], "use_pca":True, "use_sfa":True,
    # "operation":"average", "max_lenght_slow_part":10, "max_num_samples_for_ev":400,
    # "max_test_samples_for_ev":400, "k":48, "max_preserved_sfa":2.0}
    # ################# Default:
    #    layer.sfa_args = {"expansion_funcs":[identity, unsigned_08expo], "use_pca":True, "use_sfa":True,
    # "operation":"average", "max_lenght_slow_part":10, "max_num_samples_for_ev":600,
...
# "operation":"average", "max_lenght_slow_part":20, "max_num_samples_for_ev":1200,
...
# "max_lenght_slow_part":10, "max_num_samples_for_ev":1200, "max_test_samples_for_ev":1200, "k":200}
#    layer.sfa_args = {"expansion_funcs":None, "use_pca":True, "max_lenght_slow_part":6,
# "max_num_samples_for_ev":600, "max_test_samples_for_ev":600, "k":16}
network.layers[0].pca_node_class = mdp.nodes.PCANode
...
# layer.exp_funcs = [identity, pair_prod_adj1_ex, unsigned_08expo, _mix2_ex, weird_sig,
# signed_sqrt_pair_prod_mix3_ex, e_neg_sqr]
layer.exp_funcs = [identity, unsigned_08expo_m1, unsigned_08expo_p1]
# layer.red_node_class = mdp.nodes.WhiteningNode
layer.red_out_dim = len(sfa_libs.apply_funcs_to_signal(layer.exp_funcs, numpy.zeros((1, layer.pca_out_dim)))[0]) - 2
...
# expanded_dims = [104, 284, 423, 492, 552, 582, 435, 400, 350, 350, 1, 1] # Allows identity matrix in expansion
...
HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_96x96.layers = \
    HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_96x96.layers[0:9]
HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_48x48 = \
    copy.deepcopy(HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_96x96)
HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_48x48.layers = \
    HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_96x96.layers[0:6] + \
    [HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_96x96.layers[8]]
HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_24x24 = \
    copy.deepcopy(HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_96x96)
HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_24x24.layers = \
    HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_96x96.layers[0:4] + \
    [HiGSFANetworkU11L_Overlap6x6L0_Sigmoids_GUO_3Labels_96x96.layers[8]]
...
network.L9 = None
network.layers = [network.L0, network.L1, network.L2, network.L3, network.L4, network.L5, network.L6, network.L7]
# NetworkGender_8x8L0 = NetworkSetExpFuncs([identity, unsigned_08expo, signed_08expo],
# copy.deepcopy(NetworkGender_8x8L0))
...
for layer in [network.L6, network.L7, network.L8, network.L9, network.L10]:
    ...
    layer.sfa_args = {"pre_expansion_node_class": None, "final_expanded_dim": 240, "initial_expansion_size": 240,
                      "starting_point": "08Exp", "expansion_size_decrement": 150, "expansion_size_increment": 155,
                      "number_iterations": 6}
    # SFAAdaptiveNLNode( input_dim = 10, output_dim=10, pre_expansion_node_class = None,
...
# 32x32. L0 normal, L1 pair_prod_ex, rest linear. @8: 19.364, 24.672, 25.183,
# typical_delta_train= [ 0.25289074  0.32593131, typical delta_newid= [ 0.25795559  0.32364028
# 32x32. L0 pair_prod_ex, rest linear. @8: 93.007, 104.805, 95.660,
# typical_delta_train= [ 0.58488899  0.63026202, typical delta_newid= [ 0.58985147  0.61964849

# 32x32, modified, pair_prod_ex: L5lin, @8: 23.342,41.346,40.187, L4lin, @8:24.849,41.552,39.605,
# MSE_Gauss 23.287,43.627,40.215,typical_delta_train= [ 0.21459941  0.29260883,
# typical delta_newid= [ 0.24974733  0.3316066
# L1lin, @8: 36.657,63.277,61.612,typical_delta_train= [ 0.32495874  0.35448157,
# typical delta_newid= [ 0.37454736  0.40719719
# L0lin, @8: 218.509, 304.338, 271.035, typical_delta_train= [ 0.80577574  0.82477724,
# typical delta_newid= [ 1.02751328  1.01734513

# 32x32, modified, u08expo: L5lin, @8: 43.508,47.628,46.450 L4lin, @8: 36.729,36.951,36.405,
# MSE_Gauss 32.966, 38.140, 36.703, typical_delta_train= [ 0.27342929  0.36033502,
# typical delta_newid= [ 0.28085104  0.36441605
# L1lin, @8: 61.620, 59.924, 56.255, typical_delta_train= [ 0.38094301  0.40660367,
# typical delta_newid= [ 0.3734798   0.39011842
# L0lin, @8: 332.649, 348.934, 315.407, typical_delta_train= [ 0.38094301  0.40660367,
# typical delta_newid= [ 1.04749017  1.01911393

# 32x32, modified, no expo: L5lin, @8: 33.098,36.273,34.123 L4lin, @8: 33.829,34.987,34.537,
# MSE_Gauss 31.616, 36.097, 34.425 L4lin, @8: typical_delta_train= [ 0.28812816  0.3856025,
# typical delta_newid= [ 0.29035496  0.3779304
# L3lin, @8: 35.585,34.781,34.281,
# L2lin, @8: 36.345, 36.105, 34.371, typical_delta_train= [ 0.30616905  0.40299957,
# typical delta_newid= [ 0.30480867  0.38950811
# L1lin, @8: 56.887, 56.034, 50.738, typical_delta_train= [ 0.38377317  0.42976021,
# typical delta_newid= [ 0.3742282   0.41215822
# L0lin, @8: 332.513, 344.689, 317.466, typical_delta_train= [ 1.02527302  1.11769401,
# typical delta_newid= [ 1.05743285  1.11296883

# 32x32, fully original:
# New Id: 0.000 CR_CCC, CR_Gauss 0.000, CR_SVM 0.000, MSE_CCC 46.222, MSE_Gauss 36.007, MSE3_SVM 675.150,
# MSE2_SVM 675.150, MSE_SVM 675.150, MSE_LR 108.970
...
u08expo_m1p1_NetworkU11L = NetworkSetExpFuncs([identity, unsigned_08expo_m1, unsigned_08expo_p1],
                                              copy.deepcopy(nonlinearNetworkU11L))
u2_08expoNetworkU11L = NetworkSetExpFuncs([identity, unsigned_2_08expo], copy.deepcopy(nonlinearNetworkU11L),
                                          include_L0=False)

# 1.15
u08expo_pcasfaexpo_NetworkU11L = NetworkSetPCASFAExpo(copy.deepcopy(u08expoNetworkU11L), first_pca_expo=0.0,
                                                      last_pca_expo=1.0, first_sfa_expo=2.0, last_sfa_expo=1.0,
                                                      hard_pca_expo=False)
# 0.9, 1.2, False
...
u08expoA2_pcasfaexpo_NetworkU11L = NetworkSetPCASFAExpo(copy.deepcopy(u08expoA2NetworkU11L), first_pca_expo=0.0,
                                                        last_pca_expo=1.0, first_sfa_expo=1.15, last_sfa_expo=1.0,
                                                        hard_pca_expo=True)
u08expoA3_pcasfaexpo_NetworkU11L = NetworkSetPCASFAExpo(copy.deepcopy(u08expoA3NetworkU11L), first_pca_expo=0.8,
                                                        last_pca_expo=1.0, first_sfa_expo=1.05, last_sfa_expo=1.0,
                                                        hard_pca_expo=False)
u08expoA4_pcasfaexpo_NetworkU11L = NetworkSetPCASFAExpo(copy.deepcopy(u08expoA4NetworkU11L), first_pca_expo=1.0,
                                                        last_pca_expo=1.0, first_sfa_expo=1.0, last_sfa_expo=1.0,
                                                        hard_pca_expo=False)

# WARNING, ORIGINAL:
# u08expo_pcasfaexpo_NetworkU11L = NetworkSetPCASFAExpo(copy.deepcopy(u08expoNetworkU11L), first_pca_expo=0.0,
# last_pca_expo=1.0, first_sfa_expo=1.15, last_sfa_expo=1.0, hard_pca_expo=False)

experimentalNetwork = NetworkSetExpFuncs([identity, unsigned_2_08expo, pair_prodsigmoid_04_02_mix1_ex],
                                         copy.deepcopy(nonlinearNetworkU11L), include_L0=False)
...
network.layers[0].pca_node_class = mdp.nodes.PCANode
# if LRec_use_RGB_images:
#    network.layers[0].pca_out_dim = 50
# #50 Problem, more color components also remove higher frequency ones = code image as intensity+color!!!
# else:
#    network.layers[0].pca_out_dim = 20 #20 #30 #28 #20 #22 more_feats2, 50 for RGB
...
HiGSFANetworkU11L_NoOverlap_4x4L0_PosXPosYScaleAngle_128x128 = copy.deepcopy(
    HiGSFANetworkU11L_NoOverlap_4x4L0_PosXPosYScaleAngle)

HiGSFANetworkU11L_NoOverlap_4x4L0_PosXPosYScaleAngle_64x64 = copy.deepcopy(
    HiGSFANetworkU11L_NoOverlap_4x4L0_PosXPosYScaleAngle)
HiGSFANetworkU11L_NoOverlap_4x4L0_PosXPosYScaleAngle_64x64.layers = \
    HiGSFANetworkU11L_NoOverlap_4x4L0_PosXPosYScaleAngle_64x64.layers[0:-2]

HiGSFANetworkU11L_NoOverlap_4x4L0_PosXPosYScaleAngle_32x32 = copy.deepcopy(
    HiGSFANetworkU11L_NoOverlap_4x4L0_PosXPosYScaleAngle_64x64)
HiGSFANetworkU11L_NoOverlap_4x4L0_PosXPosYScaleAngle_32x32.layers = \
    HiGSFANetworkU11L_NoOverlap_4x4L0_PosXPosYScaleAngle_32x32.layers[0:-2]
...
HiGSFANetworkU11L_NoOverlap_4x4L0_Basic_PosXPosYScaleAngle_128x128 = copy.deepcopy(
    HiGSFANetworkU11L_NoOverlap_4x4L0_Basic_PosXPosYScaleAngle)

HiGSFANetworkU11L_NoOverlap_4x4L0_Basic_PosXPosYScaleAngle_64x64 = copy.deepcopy(
    HiGSFANetworkU11L_NoOverlap_4x4L0_Basic_PosXPosYScaleAngle)
HiGSFANetworkU11L_NoOverlap_4x4L0_Basic_PosXPosYScaleAngle_64x64.layers = \
    HiGSFANetworkU11L_NoOverlap_4x4L0_Basic_PosXPosYScaleAngle_64x64.layers[0:-2]

HiGSFANetworkU11L_NoOverlap_4x4L0_Basic_PosXPosYScaleAngle_32x32 = \
    copy.deepcopy(HiGSFANetworkU11L_NoOverlap_4x4L0_Basic_PosXPosYScaleAngle_64x64)
HiGSFANetworkU11L_NoOverlap_4x4L0_Basic_PosXPosYScaleAngle_32x32.layers = \
    HiGSFANetworkU11L_NoOverlap_4x4L0_Basic_PosXPosYScaleAngle_32x32.layers[0:-2]
...
HiGSFANetworkSpecial11L_Overlap_4x4L0_EyeL_64x64.layers[-5].sfa_args["expansion_funcs"] = [identity, unsigned_08expo,
                                                                                           ch3o0s4QT]
HiGSFANetworkSpecial11L_Overlap_4x4L0_EyeL_64x64.layers[-3].sfa_args["expansion_funcs"] = [identity, unsigned_08expo,
                                                                                           ch3o0s4QT]
HiGSFANetworkSpecial11L_Overlap_4x4L0_EyeL_64x64.layers[-1].sfa_args["expansion_funcs"] = [identity, unsigned_08expo,
                                                                                           ch3o24s10QT]
...
# "expansion_funcs":[identity, div2_sel75_unsigned_08expo], "max_lenght_slow_part":10,
# "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999} #2.0
#    layer.sfa_node_class = mdp.nodes.iGSFANode
#    layer.sfa_out_dim = HiGSFANet_out_dims[8]
#    layer.sfa_args = {"pre_expansion_node_class":None, "expansion_funcs":[identity, sel8_04QT],
# "max_lenght_slow_part":10,   "offsetting_mode":"sensitivity_based_pure", "max_preserved_sfa":1.99999} #2.0
